...
public class NewTimeEx {
    public static void main(String[] args) {
        ...
        LocalDate birthDate = LocalDate.of(2000, 7, 14);
        ...
        System.out.println(birthDate.withYear(2024));
        System.out.println(birthDate.plusDays(1));
        System.out.println(birthDate.plus(1, ChronoUnit.DAYS)); // plusDays(1)과 동일
